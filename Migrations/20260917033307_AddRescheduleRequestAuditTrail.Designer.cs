...
namespace AriesMagicAppointmentSystem.Migrations
{
    ...
    [Migration("20260917033307_AddRescheduleRequestAuditTrail")]
    partial class AddRescheduleRequestAuditTrail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.ConversationParticipant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.EmailVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.OcrVerification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("DuplicatePaymentId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ExtractedPaymentMethod")
                        .HasMaxLength(80)
                        .HasColumnType("nvarchar(80)");

                    b.Property<string>("ExtractedReceiver")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("ExtractedReferenceNumber")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("ExtractedSender")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("ExtractedTime")
                        .HasMaxLength(40)
                        .HasColumnType("nvarchar(40)");

                    b.Property<bool>("IsDuplicateReference")
                        .HasColumnType("bit");
                    ...
                    b.HasIndex("ExtractedReferenceNumber");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.RefundRequest", b =>
                {
                    ...
                    b.Property<string>("RefundProofImagePath")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.RescheduleRequest", b =>
                {
                    ...
                    b.Property<string>("ClientFacingReason")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.Conversation", b =>
                {
                    ...
                    b.HasOne("AriesMagicAppointmentSystem.Models.ApplicationUser", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.ConversationParticipant", b =>
                {
                    b.HasOne("AriesMagicAppointmentSystem.Models.Conversation", "Conversation")
                        .WithMany("Participants")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AriesMagicAppointmentSystem.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.EmailVerification", b =>
                {
                    b.HasOne("AriesMagicAppointmentSystem.Models.ApplicationUser", "User")
                        .WithOne()
                        .HasForeignKey("AriesMagicAppointmentSystem.Models.EmailVerification", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.Message", b =>
                {
                    ...
                    b.HasOne("AriesMagicAppointmentSystem.Models.ApplicationUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.OcrVerification", b =>
                {
                    b.HasOne("AriesMagicAppointmentSystem.Models.Payment", "Payment")
                        .WithMany("OcrVerifications")
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("AriesMagicAppointmentSystem.Models.RefundRequest", "RefundRequest")
                        .WithMany("OcrVerifications")
            ...
            modelBuilder.Entity("AriesMagicAppointmentSystem.Models.RefundRequest", b =>
                {
                    ...
                    b.HasOne("AriesMagicAppointmentSystem.Models.Payment", "OriginalPayment")
                        .WithMany()
